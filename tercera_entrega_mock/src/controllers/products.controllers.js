...
const getAll = async (req, res) => {
  try {
    ...
    logger.log("error", "products.controller.getAll");
    next(error);
  }
};
...
const getById = async (req, res) => {
  try {
    ...
    console.log(error);
    //res.status(500).json({ status: "Error", msg: "Error interno del servidor" });
    logger.log("error", "products.controller.getById");
    next(error)
  }
};
...
const create = async (req, res) => {
  try {
    ...
    console.log(error);
    //res.status(500).json({ status: "Error", msg: "Error interno del servidor" });
    logger.log("error", "products.controller.create");
    next(error)
  }
};
...
const update = async (req, res) => {
  try {
    ...
    console.log(error);
    //res.status(500).json({ status: "Error", msg: "Error interno del servidor" });
    logger.log("error", "products.controller.update");
    next(error);
  }
};
...
const deleteOne = async (req, res) => {
  try {
    ...
    console.log(error);
    //res.status(500).json({ status: "Error", msg: "Error interno del servidor" });
    logger.log("error", "products.controller.deletOne");
    next(error);
  }
};
